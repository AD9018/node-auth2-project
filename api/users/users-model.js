...
return db('users as u').join('roles as r','r.role_id','u.role_id').select('u.user_id','u.username','r.role_name')
...
function findBy(filter) {
  ...
  return db('users as u').join('roles as r','r.role_id','u.role_id').select('u.user_id','u.username','r.role_name','u.password').where(filter)
...
return db('users as u').join('roles as r','r.role_id','u.role_id').select('u.user_id','u.username','r.role_name').where({user_id}).first()
